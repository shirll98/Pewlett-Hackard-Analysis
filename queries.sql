...
# add the emp_no into the retirement_info table 
# drop the table using 
    # DROP TABLE retirement_info; 
    # notice that we didn't need to add the CASCADE bc it hasnt formed any connections 
    with other tables yet 
...
imagine a table on the left and right of each other, instead of a list 
inner join, return a matching 
